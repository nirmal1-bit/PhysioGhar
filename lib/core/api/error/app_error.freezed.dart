...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ServerError error)?  serverError,TResult Function( ValidationError validationError)?  validationError,TResult Function( NoInternetError error)?  noInternet,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ServerError() when serverError != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ServerError error)  serverError,required TResult Function( ValidationError validationError)  validationError,required TResult Function( NoInternetError error)  noInternet,}) {final _that = this;
switch (_that) {
case _ServerError():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ServerError error)?  serverError,TResult? Function( ValidationError validationError)?  validationError,TResult? Function( NoInternetError error)?  noInternet,}) {final _that = this;
switch (_that) {
case _ServerError() when serverError != null:
return serverError(_that.error);case _ValidationError() when validationError != null:
return validationError(_that.validationError);case _NoInternet() when noInternet != null:
